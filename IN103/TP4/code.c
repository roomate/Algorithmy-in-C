...
/** \brief Fonction de parcours récursif de l'arbre de Huffman permettant
    ...
    de la descente et recopiera, une fois arrivée à une feuille, la chaîne de
    ...
    \return Booléen disant si la mémorisation des codes s'est passée
    correctement.
...
char** get_codes (struct huff_node_t *tree)
{
  ...
  /* Initialisation des codes  "aucune chaîne". */
